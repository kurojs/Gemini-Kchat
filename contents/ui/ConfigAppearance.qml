    ...
    Kirigami.FormLayout {
        ...
        QQC2.ComboBox {
            ...
            property var modelLabels: [
                ...
                i18nc("@item:inlistbox", "Gemini 3.8 Flash"),
                i18nc("@item:inlistbox", "Gemini 3.7 Flash"),
                i18nc("@item:inlistbox", "Gemini 3.6 Flash"),
                i18nc("@item:inlistbox", "Gemini 3.5 Flash"),
                i18nc("@item:inlistbox", "Gemini 3.5 Flash-Lite"),
        ...
        Kirigami.InlineMessage {
            ...
            text: {
                var descriptions = [
                    ...
                    i18nc("@info", "V3.8 generation. Latest stable. Fast and agentic."),
                    i18nc("@info", "V3.7 generation. Fast, efficient, thinking-enabled."),
                    i18nc("@info", "V3.6 generation. Fast, efficient, thinking-enabled."),
                    i18nc("@info", "V3.5 generation. Flagship reasoning and coding."),
                    i18nc("@info", "V3.5 Flash-Lite. Cost-efficient and fast."),
                    i18nc("@info", "V3.1 Pro. Advanced multimodal reasoning."),
                    i18nc("@info", "V3.1 Flash-Lite. Most cost-efficient model."),
